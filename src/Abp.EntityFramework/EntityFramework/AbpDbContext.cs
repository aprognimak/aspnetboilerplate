    ...
    public abstract class AbpDbContext : DbContext, ITransientDependency, IShouldInitialize
    {
        ...
        protected virtual void ConfigureFilters(DbModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Filter(AbpDataFilters.MustHaveTenant,
                (IMustHaveTenant t, Guid tenantId) => t.TenantId == tenantId || (Guid?) t.TenantId == null, Guid.Empty); //While "(int?)t.TenantId == null" seems wrong, it's needed. See https://github.com/jcachat/EntityFramework.DynamicFilters/issues/62#issuecomment-208198058
